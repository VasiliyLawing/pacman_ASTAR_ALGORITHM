...
private data class Bomb(var x: Double, var y: Double, var speed: Double = 0.0)

// Change 250 to a smaller number to have more bombs
...
private fun processBombs(bombs: MutableList<Bomb>, terminalY: Int, g: Double) {
    ...
    bombs.removeIf { it.y >= terminalY }
}

private fun drawBombs(g: Graphics, bombs: List<Bomb>) {
    val bombSize = 15
